    ...
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-4">
          <Avatar size="lg" alt={referrer.fullName} src={referrer.profilePhoto} />
          <div className="flex-1">
            <h3 className="text-lg font-bold">{referrer.alias}</h3>
            <p className="text-gray-600 text-sm">{referrer.role} at {referrer.maskedCompany}</p>
